...
#score
    ...
    filename = 'uni' + str(uniqueness) + 'res' + str(responsiveness)+ 'new testWW'  + '60ptps.csv'
    result = []
    #old_data = pd.read_csv(filename, header = 0)
    #result.append(accus.keys())
    #result.append(old_data.values[0])
    result.append(accus.values())
    #result.append(old_data.values[1])
