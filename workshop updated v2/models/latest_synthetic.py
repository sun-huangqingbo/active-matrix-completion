...
def Simulate_Once(currdata, step, panelty):
    ...
    core_num = min(20, multiprocessing.cpu_count())
...
def main(uniqueness, responsiveness, strategy, phenotype_num):
    ground_truth10 =  Generating_Truth(100, uniqueness, responsiveness, phenotype_num)
    ground_truth10 = AddNoise(ground_truth10, 0.0, phenotype_num)
    # ground_truth10 = Generating_Truth(100, uniqueness, responsiveness, phenotype_num)
    currdata = Initialize_Data(ground_truth10, 100)
    total0 = CountKnownNum(ground_truth10)
...
#active learning
    ...
    while knownnum < total:
        ...
        accu = 1 - (count - correct)/total0
        accus[knownnum] = accu
        pred_accu.append(correct / count)
