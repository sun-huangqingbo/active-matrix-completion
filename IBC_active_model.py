...
def main(uniqueness, responsiveness, noise, phenotype_num):
    ground_truth10 =  Generating_Truth(20, uniqueness, responsiveness, phenotype_num)
    ground_truth10 = AddNoise(ground_truth10, noise, phenotype_num)
    currdata = Initialize_Data(ground_truth10, 4)
    ...
    while knownnum < total:
        ...
        for selection in selections2:
            ...
            currdata[row][col] = ground_truth10[row][col]
        knownnum = CountKnownNum(currdata)
        filename = 'IBC_active_training_data.csv'
        result = []
        result = []
